...
const contacts = [
  { name: 'VARGO', notes: 'BATCHMATE + will win shubham relative, aromist prateek gym with gaurav bhaiya', assigned_to: 'Brother' },
  { name: 'AMKASH', notes: 'MET AT EXHIBITION, WILL WIN REFERENCE', assigned_to: 'Brother' },
  { name: 'ALMONARD', notes: 'FOLLOWUP', assigned_to: 'Brother' },
  { name: 'BESTON', notes: 'MEET AT FACTORY , AVOID CREDIT', assigned_to: 'Brother' },
  ...
  { name: 'EKKA', notes: 'PICKUP HIS SAMPLES AND DEVELOPMENT COOLER AND INFRA', assigned_to: 'Brother' },
  { name: 'IMPEX', notes: 'KETTLE SAMPLES?? INDUCTION SAMPLES SUMBIT', assigned_to: 'Brother' },
  ...
  { name: 'MAIRA COOLER', notes: 'MEET', assigned_to: 'Brother' },
  ...
  { name: 'VICTURA', notes: 'SUMBITED CARD', assigned_to: 'Brother' },
